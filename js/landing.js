...
submitBtn.addEventListener("click",(event)=>{
    ...
    query += "?" + "city=" + city  + "&limit=20"  ; //"&" + "state=" + state // string concatenation 
	...
	.then(data => {
      ...
      data.forEach((d, i)=>{ // for each loop on the data array which is an array of objects that contains info about each property listing
          ...
          let h4El = document.createElement("h4"); // created new h4 element and assigned it to h3EL
          ...
          let pEl = document.createElement("p"); // created new p element and assigned it to pEL
          ...
          divEl.appendChild(h4El);// appended to div element 
          divEl.appendChild(pEl);// appended to div element 
          divEl.appendChild(secPEL);
          divEl.appendChild(buttonEl);// appended to div element 
